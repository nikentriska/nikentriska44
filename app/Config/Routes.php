...
$routes->add('addregister','LoginController::saveregister');
$routes->get('/logout','LoginController::logout');

$routes->get('/petugas','PetugasController::index');
$routes->add('petugas','PetugasController::save');
$routes->get('/petugas/delete/(:segment)','PetugasController::hapus/$1');
...
$routes->get('/masyarakat/delete/(:segment)','MasyarakatController::hapus/$1');
...
$routes->add('/tanggapi', 'PengaduanController::/tanggapi');
